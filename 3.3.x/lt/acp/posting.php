...
$lang = array_merge($lang, array(
	...
	'BBCODE_INVALID_TEMPLATE'	=> 'Jūsų BBKodo šablonas yra netinkamas.',
	...
	'tokens'	=>	array(
		...
		'ALNUM'			=> 'Lotų abecėlės (A-Z) simboliai ir skaičiai.',
		'CHOICE'		=> 'Pasirinkimas iš nurodytų reikšmių, pvz. <samp>{CHOICE=spades,hearts,diamonds,clubs}</samp>.',
		'FLOAT'			=> 'Decimalė reikšmė, pvz. <samp>0.5</samp>.',
		'HASHMAP'		=> 'Keičia eilutes į jų atitikmenis: <samp>{HASHMAP=string1:replacement1,string2:replacement2}</samp>.',
		'INT'			=> 'Sveikasis skaičius, pvz. <samp>2</samp>.',
		'IP'			=> 'Tinkamas IPv4 arba IPv6 adresas.',
		'IPPORT'		=> 'Tinkamas IPv4 arba IPv6 adresas su portų numeriu.',
		'IPV4'			=> 'Tinkamas IPv4 adresas.',
		'IPV6'			=> 'Tinkamas IPv6 adresas.',
		'MAP'			=> 'Keičia eilutes į jų atitikmenis (neskiria didžiųjų ir mažjų raidių): <samp>{MAP=string1:replacement1,string2:replacement2}</samp>.',
		'RANGE'			=> 'Priima sveikąjį skaičių nurodytame diapazone, pvz. <samp>{RANGE=-10,42}</samp>.',
		'REGEXP'		=> 'Tikrina savo reikšmę pagal nurodytą reguliariąjį išraišką, pvz. <samp>{REGEXP=/^foo\w+bar$/}</samp>.',
		'TIMESTAMP'		=> 'Laiko žymė, pvz. <samp>1h30m10s</samp>, bus paversta į sekundių skaičių.',
		'UINT'			=> 'Teigiamas sveikasis skaičius. Toks pats kaip <samp>{INT}</samp>, bet atmetamos reikšmės, mažesnės už 0.',
	),
));
