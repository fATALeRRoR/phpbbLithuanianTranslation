...
$lang = array_merge($lang, array(
	...
	'COLLIDING_CLEAN_USERNAME'			=> '<strong>%s</strong> yra valytas vartotojo vardas:',
	'COLLIDING_USER'					=> '» vartotojo ID: <strong>%d</strong> vartotojo vardas: <strong>%s</strong> (%d pranešimų)',
	'COLLIDING_USERNAMES_FOUND'			=> 'Senoje lentoje rasti sutampantys vartotojo vardai. Norėdami užbaigti konvertavimą, ištrinkite arba pervadinkite šiuos vartotojus taip, kad kiekvienam valytam vartotojo vardui atitiktų tik vienas vartotojas.',
	'CONV_ERR_FATAL'					=> 'Mirtina konvertavimo klaida',
