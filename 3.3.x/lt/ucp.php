...
$lang = array_merge($lang, array(	
	...
	'AUTOLOGIN_SESSION_KEYS_DELETED'=> 'Pasirinkti „Prisiminti mane“ prisijungimo raktai sėkmingai ištrinti.',	
	'AVATAR_CATEGORY'	=> 'Kategorija',
	'AVATAR_DRIVER_GRAVATAR_TITLE'	=> 'Gravatar',
	'AVATAR_DRIVER_GRAVATAR_EXPLAIN'=> 'Gravatar yra paslauga, leidžianti prie daugelio svetainių naudoti tą patį avatarinį vaizdą. Daugiau informacijos: <a href="http://www.gravatar.com/">Gravatar</a>.',
	'AVATAR_DRIVER_LOCAL_TITLE'		=> 'Galerijos avataras',
	'AVATAR_DRIVER_LOCAL_EXPLAIN'	=> 'Galite pasirinkti avatarinį vaizdą iš lokaliai prieinamų avatarų rinkinio.',
	'AVATAR_DRIVER_REMOTE_TITLE'	=> 'Nuotolinis avataras',
	'AVATAR_DRIVER_REMOTE_EXPLAIN'	=> 'Nuoroda į avataro vaizdą kitą svetainėje.',
	'AVATAR_DRIVER_UPLOAD_TITLE'	=> 'Įkelti avatarinį vaizdą',
	'AVATAR_DRIVER_UPLOAD_EXPLAIN'	=> 'Įkelkite savo asmeninį avataro vaizdą.',	
	'AVATAR_EXPLAIN'	=> 'Maksimalūs dydžiai; plotis: %1$d pikseliai, aukštis: %2$d pikseliai, failo dydis: %3$.2f KiB.',
	'AVATAR_EXPLAIN_NO_FILESIZE'	=> 'Maksimalūs dydžiai; plotis: %1$s, aukštis: %2$s.',	
	...
	'AVATAR_SELECT'					=> 'Pasirinkite savo avatarinį vaizdą',
	...
	'FIELD_TOO_LARGE'	=> 'Laukelio “%1$s” reikšmė yra per didelė. Didžiausia galima reikšmė - %2$d.',
		'FIELD_INVALID_CHARS_INVALID'		=> 'Laukelyje "%s" yra netinkamų simbolių.',	
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'Laukelyje “%s” yra neleistinų simbolių. Jame galima rašyti tik skaičius.',
		'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiami tik raidinių-skaitinių arba . simboliai.',	
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Laukelyje “%s” yra neleistinų simbolių. Jame galima rašyti tik skaičius ir raides.',
		'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiami tik raidinių-skaitinių arba _,-. simboliai, o pirmasis simbolis turi būti raidė.',	
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Laukelyje “%s” yra neleistinų simbolių. Jame galima rašyti tik skaičius, raides, tarpus arba simbolius -+_[].',
		'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiami tik raidinių-skaitinių arba _ simboliai.',
		'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiamos tik raidės, skaičiai arba . simboliai.',
		'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiamos tik raidės ir skaičiai.',
		'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiamos tik raidės, skaičiai arba _,-. simboliai, o pirmasis simbolis turi būti raidė.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'Laukelyje “%s” yra neleistinų simbolių. Jame galima rašyti tik skaičius, raides, tarpus arba simbolius -+_[].',
		'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Laukelyje "%s" yra netinkamų simbolių. Leidžiamos tik raidės, skaičiai arba _ simboliai.',	
	'FIELD_INVALID_DATE'	=> 'Laukelyje “%s” įrašyta neteisinga data.',
		'FIELD_INVALID_URL'					=> 'Laukelyje "%s" yra neteisingas URL adresas.',	
	...
	'GRAVATAR_AVATAR_EMAIL'			=> 'Gravatar el. pašto adresas',
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Įveskite el. pašto adresą, kurį naudojote registruodamiesi <a href="http://www.gravatar.com/">Gravatar</a>.',
	'GRAVATAR_AVATAR_SIZE'			=> 'Avataro matmenys',
	'GRAVATAR_AVATAR_SIZE_EXPLAIN'	=> 'Nurodykite avataro plotį ir aukštį; palikite tuščią automatiniam nustatymui.',	
	...
	'LOGIN_LINK'					=> 'Susieti arba registruoti savo paskyrą išorinėje paslaugoje su forumo paskyra',
	'LOGIN_LINK_EXPLAIN'			=> 'Jūs bandėte prisijungti naudodami išorinę paslaugą, kuri dar nesusieta su jokia šio forumo paskyra. Dabar turite arba susieti šią paskyrą su esama paskyra, arba sukurti naują.',
	'LOGIN_LINK_MISSING_DATA'	=> 'Duomenys, reikalingi susieti paskyrą su išorine paslauga, nėra pateikti. Pradėkite prisijungimo procesą iš naujo.',
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Į šį puslapį nepateikta jokių duomenų, kad būtų galima susieti išorinę paskyrą su forumo paskyra. Jei probelemos kartojasi, susisiekite su forumo administratoriumi.',
	...
	'NOTIFICATIONS_MARK_ALL_READ'						=> 'Pažmėti visus pranešimus kaip skaitytus',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'								=> 'Ar tikrai norite pažmėti visus pranešimus kaip skaitytus?',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'								=> 'Visi pranešimai pažmėti kaip skaityti.',
	...
	'NOTIFICATION_GROUP_POSTING'						=> 'Puslapių pranešimai',
	'NOTIFICATION_METHOD_BOARD'							=> 'Pranešimai',
	'NOTIFICATION_METHOD_EMAIL'							=> 'Email',
	'NOTIFICATION_METHOD_JABBER'						=> 'Jabber',
	'NOTIFICATION_TYPE'									=> 'Pranešimo tipas',
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Kas nors atsakinėja į jūsų pažimėtą temą',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Kas nors prašo prisijungti prie jūsų vadovaujamos grupės',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'			=> 'Pranešimas arba tema laukia patvirtinimo',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'Jūsų temos/pranešimai patvirtinti arba atmesti moderatoriaus',
	'NOTIFICATION_TYPE_PM'								=> 'Kas nors siųnčia jums asmeninę žinučioą',
	'NOTIFICATION_TYPE_POST'						=> 'Kas nors atsako į temą, kuriai ešate užsiprenumera vęs',
	'NOTIFICATION_TYPE_FORUM'						=> 'Kas nors atsako į temą forume, kuriam esate užsiprenumera vęs',
	'NOTIFICATION_TYPE_QUOTE'						=> 'Kas nors cituoja jus pranešime',
	'NOTIFICATION_TYPE_REPORT'						=> 'Kas nors raportuoja apie pranešimą',
	'NOTIFICATION_TYPE_REPORT_CLOSED'				=> 'Moderatorius uždaro jūsų raporto pranešimą',
	'NOTIFICATION_TYPE_REPORT_PM'					=> 'Kas nors raportuoja asmeninę žinutę',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'			=> 'Moderatorius uždaro jūsų asmeninės žinutės raporto pranešimą',
	'NOTIFICATION_TYPE_TOPIC'						=> 'Kas nors sukuria temą forume, kuriam esate užsiprenumera vęs',
	'NOTIFICATION_TYPE_ADMIN_ACTIVATE_USER'			=> 'Vartotojas laukia aktyvavimo',	
	...
	'NO_AUTH_PROFILEINFO'			=> 'Jums neleidžiama keisti savo profilio informacijos.',	
	...
	'NO_AUTH_PRINT_MESSAGE'	=> 'Jums neleidžiama spausdinti asmeninių žinučių.',
	...
	'EMAIL_NOT_UNIQUE'	=> 'Nurodytas el. pašto adresas naudojamas kelių vartotojų. Dėl to papildomai nurodykite vartotojo vardą.',
	...
	'NO_RESET_TOKEN'		=> 'Jūs nenurodėte slaptažodžio atkūrimo rakto.',
	...
	'PASSWORD_RESET'				=> 'Jūsų slaptažodis sėkmingai atkurtas.',
	'PASSWORD_RESET_LINK_SENT'	=> 'Jeigu tokia paskyra egzistuoja, slaptažodžio atkūrimo nuoroda išsiųsta jūsų registruotu el. pašto adresu.',
	'PASSWORD_UPDATED_IF_EXISTED'	=> 'Naujas slaptažodis išsiųstas jūsų el. pašto adresu.',
	...
	'PM_INBOX'	=> 'Gautos',
	'PM_MARK_ALL_READ'			=> 'Pažmėti visas žinutes kaip skaitytas',
	'PM_MARK_ALL_READ_SUCCESS'	=> 'Visos asmeninės žinutės šiame kataloge pažmėtos kaip skaitytos',	
	'PM_NO_USERS'	=> 'Nurodyti vartotojai neegzistuoja.',
	'PM_OUTBOX'	=> 'Siunčiamos',
	'PM_SENTBOX'	=> 'Išsiųstos',
	'PM_SUBJECT'	=> 'Žinutės tema',
	'PM_TO'	=> 'Kam',
	'PM_TOOLS'						=> 'Žinutės įrankių juosta',
	'PM_USERS_REMOVED_NO_PERMISSION'	=> 'Kai kurie vartotojai negalėjo būti pridėti, nes neturi leidimo skaityti asmenines žinutes.',	
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> '„Prisiminti mane“ prisijungimo raktai automatiškai jungia jus prie forumo. Atsijungus, raktas ištrinamas tik tame kompiuteryje, kuriame atsijungėte. Čia galite matyti prisijungimo raktus, sukurtus kituose kompiuteriuose.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Nėra išsaugotų „Prisiminti mane“ prisijungimo raktų.',	
	
	'RECIPIENT'	=> 'Gavėjas',
	'RECIPIENTS'	=> 'Gavėjai',
	'REGISTRATION'	=> 'Registracija',
	'OAUTH_REGISTRATION'	=> 'Registracija naudojant išorines paslaugas',
	...
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> 'Slaptažodžio atkūrimo raktas, kurį nurodote, yra netinkamas arba jo galiojimo laikas baigėsi.',
	...
	'TIMEZONE_DATE_SUGGESTION'	=> 'Siūlymas: %s',
	'TIMEZONE_INVALID'			=> 'Pasirinkta laiko juosta yra netinkama.',	
	'TO'	=> 'Kam',
	'TO_MASS'					=> 'Gavėjai',
	...
	'UCP_AUTH_LINK_ASK'			=> 'Šiuo metu neturite paskyros, susietos su šia išorine paslauga. Spustelėkite žemiau esančį mygtuką, kad susietumėte savo forumo paskyrą su šios išorinės paslaugos paskyra.',
	'UCP_AUTH_LINK_ID'			=> 'Unikalus identifikatorius',
	'UCP_AUTH_LINK_LINK'		=> 'Susieti',
	'UCP_AUTH_LINK_MANAGE'		=> 'Tvarkyti išorinių paskyrų susiejimus',
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Forumo paskyrų susiejimas su išorinėmis paslaugomis nėra palaikomas šio forumo autentifikacijos metodo.',
	'UCP_AUTH_LINK_TITLE'		=> 'Tvarkyti savo išorinių paskyrų susiejimus',
	'UCP_AUTH_LINK_UNLINK'		=> 'Atsiejti',	
	...
	'UCP_LOGIN_LINK'			=> 'Nustatyti išorinės paskyros susiejimą',	
	...
	'UCP_NOTIFICATION_LIST_EXPLAIN'		=> 'Čia galite peržiūrėti visus praejusių pranešimų archyvą.',
	'UCP_NOTIFICATION_OPTIONS'			=> 'Redaguoti pranešimų nustatymus',
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Čia galite nustatyti pageidaujamus pranešimų būdus.',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Tvarkyti „Prisiminti mane“ prisijungimo raktus',
	
	'UCP_USERGROUPS'	=> 'Vartotojų grupės',
	'UCP_USERGROUPS_MEMBER'	=> 'Keisti narystę',
	'UCP_USERGROUPS_MANAGE'	=> 'Valdyti grupes',
	
	'UCP_PASSWORD_RESET_DISABLED'	=> 'Slaptazoždžio atkryrimo funkcija išjungta. Jei reikia pagalbos prisijungiant prie paskyros, susisiekite su %sforumo administratoriumi%s',
